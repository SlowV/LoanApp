		...
		* {
		...
		@media screen and (max-width: 400px) {
			html, body {
				...
				height: 100vh;
				margin: 0;
				background: url("{{secure_asset('img/hinh-nen-full-hd-cho-smartphone-dep_s2108.jpg')}}") no-repeat center center fixed;
				-webkit-background-size: cover;
				-moz-background-size: cover;
				-o-background-size: cover;
				background-size: cover;
...
<div class="wrapper hidden" style="transition: .5s; ">
	...
	<audio id="audio" src="{{secure_asset('media/THẰNG-ĐIÊN.mp3')}}" loop="true" autoplay style="visibility:hidden;display: none; opacity: 0;"></audio>
</div><!-- /wrapper -->
    ...
    $('.name').keypress(function (event) {
        ...
        if (keycode == '13' && name != null) {
            if (name == "loan") {
                ...
                $('#body').attr('style', 'background:url({{secure_asset('img/bg2mobile.jpg')}}); background-size:cover;');
